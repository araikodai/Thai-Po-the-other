    ...
    <script type="text/javascript">
        ...
        function on_filter_key_up (e)
        {
            if (13 == e.keyCode) {
                ...
                $('#<?php echo $sCheckboxId; ?>').removeAttr('checked');
                return true;
            }
        }
    </script>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input_wrapper input_wrapper_text bx-def-round-corners-with-border">
                                <input type="text" id="{$sInputId}" value="{$sFilterValue}" class="form_input_text bx-def-font" onkeypress="return on_filter_key_up(event)" />
                            </div>
                        </td>
