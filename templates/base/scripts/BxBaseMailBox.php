                            ...
                            'inputs' => array(
                                'actions' => array(
                                    ...
                                    array (
                                        ...
                                        'attrs'     => array('onclick' => 'if ( typeof oMailBoxViewMessage != \'undefined\') oMailBoxViewMessage.markMessages(\'read\', ' . $aRow['ID'] . ')'),
                                    ),
                                    array (
                                        'type'      => 'button',
                                        'value'     => $aLanguageKeys['mark_unread'],
                                        'attrs'     => array('onclick' => 'if ( typeof oMailBoxViewMessage != \'undefined\') oMailBoxViewMessage.markMessages(\'unread\', ' . $aRow['ID'] . ')'),
                                    )
                                )
                            )
                        );
        ...
        function getBlockCode_NewMessages($bShowEmpty = true)
        {
            ...
            foreach($aMessages as $aMessage) {
                $aTmplVars['bx_repeat:messages'][] = array(
                    ...
                    'message_ago' => _format_when($aMessage['DateUTS']),
                        ...
                        $aMessageRows[] = array
                         (
                            ...
                            'message_date' => $aItems['Date'],
                             'message_ago' => _format_when($aItems['DateUTS']),
                                    ...
                                    'inputs' => array(
                                        'actions' => array(
                                            ...
                                            array (
                                                'type'      => 'button',
                                                'value'     => $aLanguageKeys['mark_read'],
                                                'attrs'     => array('onclick' => 'if ( typeof oMailBoxMessages != \'undefined\' ) oMailBoxMessages.markMessages(\'read\', \'genMessagesRows\')'),
                                            ),
                                            array (
                                                'type'      => 'button',
                                                'value'     => $aLanguageKeys['mark_unread'],
                                                'attrs'     => array('onclick' => 'if ( typeof oMailBoxMessages != \'undefined\' ) oMailBoxMessages.markMessages(\'unread\', \'genMessagesRows\')'),
                                            )
                                        )
                                    )
                                );
