                                    ...
                                    'inputs' => array(
                                        'actions' => array(
                                            ...
                                            0 => array (
                                                ...
                                                'attrs'     => array('onclick' => "if ( typeof " . $sJsObject . " != 'undefined' ) " . $sJsObject . ".sendAction('communicator_container', 'accept_friends_request', 'getProcessingRows')"),
                                            ),
                                            1 => array (
                                                'type'      => 'button',
                                                'value'     => $aLanguageKeys['reject'],
                                                'attrs'     => array('onclick' => "if ( typeof " . $sJsObject . " != 'undefined' ) " . $sJsObject . ".sendAction('communicator_container', 'reject_friends_request', 'getProcessingRows')"),
                                            ),
                                        )
                                    )
                                );
                                    ...
                                    'inputs' => array(
                                        'actions' => array(
                                            ...
                                            0 => array (
                                                ...
                                                'attrs'     => array('onclick' => "if ( typeof " . $sJsObject . " != 'undefined' ) " . $sJsObject . ".sendAction('communicator_container', 'delete_friends_request', 'getProcessingRows')"),
                                            ),
                                        )
                                    )
                                );
                                    ...
                                    'inputs' => array(
                                        'actions' => array(
                                            ...
                                            0 => array (
                                                ...
                                                'attrs'     => array('onclick' => "if ( typeof " . $sJsObject . " != 'undefined' ) " . $sJsObject . ".sendAction('communicator_container', 'add_hotlist', 'getProcessingRows')"),
                                            ),
                                        )
                                    )
                                );
                                    ...
                                    'inputs' => array(
                                        'actions' => array(
                                            ...
                                            0 => array (
                                                ...
                                                'attrs'     => array('onclick' => "if ( typeof " . $sJsObject . " != 'undefined' ) " . $sJsObject . ".sendAction('communicator_container', 'delete_hotlisted', 'getProcessingRows')"),
                                            ),
                                        )
                                    )
                                );
                            ...
                            'inputs' => array(
                                'actions' => array(
                                    ...
                                    0 => array (
                                        'type'      => 'button',
                                        'value'     => $aLanguageKeys['delete'],
                                        'attrs'     => array('onclick' => "if ( typeof " . $sJsObject . " != 'undefined' ) " . $sJsObject . ".sendAction('communicator_container', 'delete_greetings', 'getProcessingRows')"),
                                    ),
                                )
                            )
                        );
                                    ...
                                    'inputs' => array(
                                        'actions' => array(
                                            ...
                                            0 => array (
                                                ...
                                                'attrs'     => array('onclick' => "if ( typeof " . $sJsObject . " != 'undefined' ) " . $sJsObject . ".sendAction('communicator_container', 'block_unblocked', 'getProcessingRows')"),
                                            ),
                                        )
                                    )
                                );
                                    ...
                                    'inputs' => array(
                                        'actions' => array(
                                            ...
                                            0 => array (
                                                ...
                                                'attrs'     => array('onclick' => "if ( typeof " . $sJsObject . " != 'undefined' ) " . $sJsObject . ".sendAction('communicator_container', 'unblock_blocked', 'getProcessingRows')"),
                                            ),
                                        )
                                    )
                                );
