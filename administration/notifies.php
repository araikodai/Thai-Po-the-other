...
function PageCodeManageSubscribers($oSubscription)
{
    ...
    return array('page_main_code' => DesignBoxAdmin(_t('_Settings'), $s, $GLOBALS['aTopItems'], '', 1));
}
...
function PageCodeSettings()
{
    ...
    return array('page_main_code' => DesignBoxAdmin(_t('_adm_page_cpt_manage_subscribers'), $s, $GLOBALS['aTopItems'], '', 11));
}
