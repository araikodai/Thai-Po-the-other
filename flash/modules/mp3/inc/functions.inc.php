...
function renameFile($sUserId, $sFileId)
{
    ...
    $sTempThumb = $sFilesPathMp3 . $sUserId . TEMP_FILE_NAME . SCREENSHOT_EXT;
    if(file_exists($sTempThumb)) rename($sTempThumb, $sFilesPathMp3 . $sFileId . SCREENSHOT_EXT);
...
function deleteTempMp3s($sUserId, $bSourceOnly = false)
{
    ...
    @unlink($sFilesPathMp3 . $sTempFile . SCREENSHOT_EXT);
}
