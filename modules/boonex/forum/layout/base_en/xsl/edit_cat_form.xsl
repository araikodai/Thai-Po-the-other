	...
	<div class="wnd_box">
        ...
        <div class="wnd_content bx-def-padding">
            <form name="orca_edit_cat" onsubmit="var x=document.getElementById('js_code').innerHTML; eval(x); return false;">
                ...
                <fieldset class="form_field_row bx-def-margin-bottom"><legend>Group name:</legend>
                    <input class="forum_form_field bx-def-font-large bx-def-round-corners-with-border" type="text" name="cat_name" value="{cat_name}" />
                </fieldset>

                <fieldset class="form_field_row bx-def-margin-bottom"><legend>Expand group by default:</legend>
                ...
                <fieldset class="form_field_row bx-def-margin-bottom"><legend>Group order:</legend>
