		...
		<div class="wnd_content bx-def-padding">
            <form name="orca_edit_forum" onsubmit="var x=document.getElementById('js_code').innerHTML; eval(x); return false;">
				...
				<fieldset class="form_field_row">
                    <input type="submit" name="submit_form" value="Submit" onclick="var x=document.getElementById('js_code').innerHTML; eval(x); return false;" class="bx-btn" />
                    <input type="reset" value="Cancel" onclick="f.hideHTML(); return false;" class="bx-btn bx-def-margin-sec-left"  />
