...
<xsl:template match="search">
    ...
    <xsl:call-template name="box">
        <xsl:with-param name="title">Search The Forum</xsl:with-param>
        ...
        <div class="bx-def-bc-padding">
            ...
            <form name="new_search" method="post" target="search" onsubmit="return f.search (this.search_text.value, (this.search_type[0].checked ? this.search_type[0].value : this.search_type[1].value), this.search_forum.value, this.search_author.value, (this.search_display[0].checked ? this.search_display[0].value : this.search_display[1].value));">
                ...
                <div class="search_box">
                    ...
                    <div class="search_field bx-def-margin-bottom">
                        <div>Where to Search:</div>
                        <span class="search_input">
                            <input type="radio" name="search_type" id="search_type_tlts" value="tlts" style="position:static;" checked="checked"/> <label for="search_type_tlts">Topic Titles</label>
                            &#160; &#160; &#160;
                            <input type="radio" name="search_type" id="search_type_msgs" value="msgs" style="position:static;" /> <label for="search_type_msgs">Messages</label>
                        </span>
                    </div>
                    ...
                    <div class="search_field bx-def-margin-bottom">
                        <div>Display:</div>
                        <span class="search_input">
                            <input type="radio" name="search_display" id="search_display_topics" value="topics" style="position:static;" checked="checked"/> <label for="search_display_topics">Topics</label>
                            &#160; &#160; &#160;
                            <input type="radio" name="search_display" id="search_display_posts" value="posts" style="position:static;" /> <label for="search_display_posts">Posts</label>
                        </span>
                    </div>

                    <div class="search_field">
                        <input type="submit" name="search_submit" value="Submit" onclick="var ff=document.forms['new_search'].elements; return f.search (ff.search_text.value, (ff.search_type[0].checked ? ff.search_type[0].value : ff.search_type[1].value), ff.search_forum.value, ff.search_author.value, (ff.search_display[0].checked ? ff.search_display[0].value : ff.search_display[1].value));" class="bx-btn" />
