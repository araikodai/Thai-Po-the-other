	...
	<div class="wnd_box">
        ...
        <div class="wnd_content bx-def-padding">
            <form name="move_topic" onsubmit="var x=document.getElementById('js_code').innerHTML; eval(x); return false;">
                ...
                <fieldset class="form_field_row bx-def-margin-bottom"><legend>Forum to move topic to:</legend>
                    <select name="forum">
                ...
                <fieldset class="form_field_row bx-def-margin-bottom"><legend>After moving go to:</legend>
                    <select name="goto_new_location">
                        <option value="0" selected="selected">Stay here</option>
                        <option value="1">Forum where topic is moved</option>
                    </select>
                </fieldset>
