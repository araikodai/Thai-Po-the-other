<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <xsl:include href="../../base_en/xsl/home.xsl" />
	...
	<div id="f_header">
        <h2>
			...
			<xsl:if test="1 = /root/logininfo/admin">
                <span>(
                    <a href="javascript: orca_admin.editCategories(); void(0);">Manage Forum</a> | 
                    <a href="javascript: orca_admin.reportedPosts(); void(0);">Reported Posts</a> | 
                    Compile Languages:
