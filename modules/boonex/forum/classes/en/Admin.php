...
OES;
    ...
    {
        return $this->getXxxPostsXML ($wp, 'getHiddenPosts', 'Hidden Posts');
    }
    ...
    {
        return $this->getXxxPostsXML ($wp, 'getReportedPosts', 'Reported Posts', '<allow_clear_report>1</allow_clear_report>');
    }
