...
require_once('BxPhotosPrivacy.php');
...
class BxPhotosPageAlbumsMy extends BxDolPageView
{
    ...
    function getBlockCode_addObjects ($iBoxId)
    {
        ...
        if (!$this->oSearch->oModule->isAllowedAdd()) {
            ...
            $sCode = $this->oTemplate->parseHtmlByName('default_margin.html', array('content' => $oUploader->GenMainAddPhotosForm(array('album' => $this->aAddParams[1]))));
        }
