    ...
    VALUES
            ('bx_poll', '[db_prefix]cmts', '[db_prefix]cmts_track', 0, 1, 90, 5, 1, -3, 'none', 0, 1, 0, 'cmt', '[db_prefix]data', 'id_poll', 'poll_comments_count', '', '');
    ...
    ('{TitleShare}', 'share', '', 'showPopupAnyHtml (\'{BaseUri}share_popup/{PollId}\');', '', 3, 'bx_poll', 0),
