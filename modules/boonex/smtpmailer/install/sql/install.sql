...
(2, 'bx_smtp', '_bx_smtp', '{siteUrl}modules/?r=smtpmailer/administration/', 'SMTP Mailer', 'envelope-alt', @iMax+1);
...
('bx_smtp_secure', 'Not Secure', @iCategId, 'Is your SMTP server requires secure connection', 'select', '', '', '0', 'Not Secure,SSL,TSL'), 
