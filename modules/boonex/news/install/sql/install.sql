...
('{sbs_news_title}', 'paper-clip', '', '{sbs_news_script}', '', 1, 'bx_news', 0),
('{del_news_title}', 'remove', '', '{del_news_script}', '', 2, 'bx_news', 0),
('{share_news_title}', 'share', '', '{share_news_script}', '', 3, 'bx_news', 0);
...
('bx_news', 'homepage', '_news_bcaption_view_main', '{site_url}modules/boonex/news/templates/base/images/icons/mobile_icon.png', 100, '{site_url}modules/?r=news/mobile_latest_entries/', '', '', @iMaxOrderHomepage, 1);
