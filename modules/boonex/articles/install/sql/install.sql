...
(2, 'bx_articles', '_articles_admin_menu_sitem', '{siteUrl}modules/?r=articles/admin/', 'For managing articles', 'file', '', '', @iOrder+1);
...
('bx_articles', '[db_prefix]comments', '[db_prefix]comments_track', 0, 1, 90, 10, 1, -3, 'none', 0, 1, 0, 'cmt', '[db_prefix]entries', 'id', 'cmts_count', 'BxArlCmts', 'modules/boonex/articles/classes/BxArlCmts.php');
...
('{sbs_articles_title}', 'paper-clip', '', '{sbs_articles_script}', '', 1, 'bx_articles', 0),
('{del_articles_title}', 'remove', '', '{del_articles_script}', '', 2, 'bx_articles', 0),
