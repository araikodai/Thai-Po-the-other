...
/*--- BEGIN: /home/araikodai/thaipo.org/public_html/plugins/jquery/jquery.ui.sortable.min.js---*/
/*! jQuery UI - v1.10.3 - 2013-05-03
* http://jqueryui.com
* Copyright 2013 jQuery Foundation and other contributors; Licensed MIT */
...
/*--- END: /home/araikodai/thaipo.org/public_html/plugins/jquery/jquery.ui.sortable.min.js---*/
...
/*--- BEGIN: /home/araikodai/thaipo.org/public_html/inc/js/classes/BxDolPageBuilder.js---*/
...
BxDolPageBuilder.prototype.openProperties = function( iBlockID ) {
	...
	$.post(
		...
		function(sData) {
			...
			oPopup.find('.dbTopMenu .dbClose a').click( function(){

                if ('undefined' != typeof(tinyMCE)) {
				    $('#form_input_html' + iBlockID, oForm).each( function() {                    
...
BxDolPageBuilder.prototype.updateBlock = function( iBlockID, sCaption ) {
	...
	$( '#buildBlock_' + iBlockID + ' a').html(sCaption).click( function() {
		_builder.openProperties( iBlockID );
		return false;
	} );
};
	...
	$.get(
		...
		function(sData) {
			...
			oForm.ajaxForm({
				success: function(sResponse){
					if (sResponse == 'OK') {
                        window.location = sParserUrl + '?Page=' + encodeURIComponent($('input[name=uri]', oForm).val());
                    } else {
...
;
/*--- END: /home/araikodai/thaipo.org/public_html/inc/js/classes/BxDolPageBuilder.js---*/
