...
/*--- BEGIN: /home/araikodai/thaipo.org/public_html/plugins/jquery/jquery.ui.tabs.min.js---*/
/*! jQuery UI - v1.10.3 - 2013-05-03
* http://jqueryui.com
* Copyright 2013 jQuery Foundation and other contributors; Licensed MIT */
...
/*--- END: /home/araikodai/thaipo.org/public_html/plugins/jquery/jquery.ui.tabs.min.js---*/
...
/*--- BEGIN: /home/araikodai/thaipo.org/public_html/administration/js/fields.js---*/
...
BxDolPFMArea.prototype.draw = function() {
	...
	$( this.inactiveBlocksZoneElement ).append(
		'<div class="build_block" id="build_block_new_' + this.id + '">' +
			'<div class="build_block_header">NEW BLOCK</div>' +
		'</div>'
	);
	...
	$( '#build_inac_items_area_' + this.id + '_col_1' ).append(
		'<div class="build_item_active" id="build_item_new_' + this.id + '">NEW_ITEM</div>'
	);
...
;
/*--- END: /home/araikodai/thaipo.org/public_html/administration/js/fields.js---*/
