...
/*--- BEGIN: /home/araikodai/thaipo.org/public_html/plugins/jquery/jquery.masonry.min.js---*/
/**
...
/*--- END: /home/araikodai/thaipo.org/public_html/plugins/jquery/jquery.masonry.min.js---*/
...
/*--- BEGIN: /home/araikodai/thaipo.org/public_html/modules/boonex/wall/js/outline.js---*/
...
/*--- END: /home/araikodai/thaipo.org/public_html/modules/boonex/wall/js/outline.js---*/
...
/*--- BEGIN: /home/araikodai/thaipo.org/public_html/modules/boonex/shoutbox/js/shoutbox.js---*/
    ...
    function BxShoutBox()
    {
        ...
        this._sendBlockRequest = function(iMessage)
        {
            ...
            $.get(this.sPageReceiver + 'block_message/' + parseInt(iMessage) + '&_r=' + _sRandom, function(sResult){
        		if(sResult) {
        			alert(sResult);
        		}
        		else {
        ...
        this.deleteMessage = function(iMessage, oLinkObject)
        {
        	...
        	$.get(this.sPageReceiver + 'delete_message/' + parseInt(iMessage) + '&_r=' + _sRandom, function(sResult){
        		if(sResult) {
        			alert(sResult);
        		}
        		else {
...
/*--- END: /home/araikodai/thaipo.org/public_html/modules/boonex/shoutbox/js/shoutbox.js---*/
