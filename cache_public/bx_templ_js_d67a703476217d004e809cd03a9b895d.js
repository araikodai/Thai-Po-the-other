...
/*--- BEGIN: http://www.thaipo.org/forum/js/en/util.js---*/
/**
...
;
/*--- END: http://www.thaipo.org/forum/js/en/util.js---*/

/*--- BEGIN: http://www.thaipo.org/forum/js/en/BxError.js---*/
/**
*                            Orca Interactive Forum Script
*                              ---------------
*     Started             : Mon Mar 23 2006
...
;
/*--- END: http://www.thaipo.org/forum/js/en/BxError.js---*/

/*--- BEGIN: http://www.thaipo.org/forum/js/en/BxXmlRequest.js---*/
/**
*                            Orca Interactive Forum Script
*                              ---------------
*     Started             : Mon Mar 23 2006
...
;
/*--- END: http://www.thaipo.org/forum/js/en/BxXmlRequest.js---*/

/*--- BEGIN: http://www.thaipo.org/forum/js/en/BxXslTransform.js---*/
/**
*                            Orca Interactive Forum Script
*                              ---------------
*     Started             : Mon Mar 23 2006
...
;
/*--- END: http://www.thaipo.org/forum/js/en/BxXslTransform.js---*/

/*--- BEGIN: http://www.thaipo.org/forum/js/en/BxForum.js---*/
/**
*                            Orca Interactive Forum Script
*                              ---------------
*     Started             : Mon Mar 23 2006
...
Forum.prototype.editPost = function (id) {
	...
	var h = function (r) {		
        ...
        if (document.getElementById('tinyEditor_'+id)) {
            ...
            tinyMCE.get('tinyEditor_'+id).setContent(postText);
        }
	}	
...
Forum.prototype.expandPost = function (id) {	
    ...
    if ($('#' + id + ':hidden').size()) {
        $('#' + id).show(this._speed);
        $('#' + id).parent().find('div.colexp2').html('<i class="sys-icon minus-sign"></i>');
    } else {
        $('#' + id).hide(this._speed);
$('#' + id).parent().find('div.colexp2').html('<i class="sys-icon plus-sign"></i>');
    }
}
...
Forum.prototype.search = function (text, type, forum, u, disp, start) {	
	...
	document.h.makeHist('action=goto&search_result=1&' + text + '&' + type + '&' + forum + '&' + u + '&' + disp + '&' + start);
...
Forum.prototype.selectCat = function (cat, id) {		
    ...
    if (e.next("[cat="+cat+"]").size()) {
        ...
        e.find('div.colexp').html('<i class="sys-icon folder-close"></i>');
        return false;
    }
...
Forum.prototype.postReplyWithQuote = function (id_f, id_t, p_id)
{
	...
	var h = function (r) {		
        ...
        if (document.getElementById('tinyEditor')) {
		    tinyMCE.execCommand('mceAddControl', false, 'tinyEditor');
            tinyMCE.get('tinyEditor').setContent(post);
        }
...
;
/*--- END: http://www.thaipo.org/forum/js/en/BxForum.js---*/

/*--- BEGIN: http://www.thaipo.org/forum/js/en/BxHistory.js---*/
/**
*                            Orca Interactive Forum Script
*                              ---------------
*     Started             : Mon Mar 23 2006
...
;
/*--- END: http://www.thaipo.org/forum/js/en/BxHistory.js---*/

/*--- BEGIN: http://www.thaipo.org/forum/js/en/BxLogin.js---*/
/**
*                            Orca Interactive Forum Script
*                              ---------------
*     Started             : Mon Mar 23 2006
...
;
/*--- END: http://www.thaipo.org/forum/js/en/BxLogin.js---*/

/*--- BEGIN: http://www.thaipo.org/forum/js/en/BxAdmin.js---*/
/**
*                            Orca Interactive Forum Script
*                              ---------------
*     Started             : Mon Mar 23 2006
...
;
/*--- END: http://www.thaipo.org/forum/js/en/BxAdmin.js---*/
