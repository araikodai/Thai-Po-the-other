...
class BxDolAdminSettings extends BxDolMistake
{
    ...
    function _saveCatAdminPassword(&$aData)
    {
        ...
        $aData['pwd_old'] = process_db_input($aData['pwd_old'], BX_TAGS_STRIP);
        $aData['pwd_new'] = process_db_input($aData['pwd_new'], BX_TAGS_STRIP);
        $aData['pwd_conf'] = process_db_input($aData['pwd_conf'], BX_TAGS_STRIP);
