...
EOS;
    ...
    $confFirst['dir_mogrify'] = array(
        ...
        'desc' => "If mogrify binary doesn't exist please install <a href='http://www.imagemagick.org/' target='_blank'>ImageMagick</a>",
        ...
        'def_exp' => "
            ...
            if ( file_exists(\"/opt/local/bin/mogrify\") ) return \"/opt/local/bin/mogrify\";
            return '';",
        'check' => 'return strlen($arg0) >= 7 ? true : false;'
    );
    $confFirst['dir_convert'] = array(
        ...
        'desc' => "If convert binary doesn't exist please install <a href='http://www.imagemagick.org/' target='_blank'>ImageMagick</a>",
        ...
        'def_exp' => "
            ...
            if ( file_exists(\"/opt/local/bin/convert\") ) return \"/opt/local/bin/convert\";
            return '';",
        'check' => 'return strlen($arg0) >= 7 ? true : false;'
    );
    $confFirst['dir_composite'] = array(
        ...
        'desc' => "If composite binary doesn't exist please install <a href='http://www.imagemagick.org/' target='_blank'>ImageMagick</a>",
        ...
        'def_exp' => "
            ...
            if ( file_exists(\"/opt/local/bin/composite\") ) return \"/opt/local/bin/composite\";
            return '';",
        'check' => 'return strlen($arg0) >= 7 ? true : false;'
    );
...
<body class="bx-def-font">
    ...
    <div class="adm-header">
        <div class="adm-header-content">
            <div class="adm-header-title bx-def-margin-sec-left">
                <img class="adm-header-logo" src="../administration/templates/base/images/logo.png" />
                <div class="adm-header-text bx-def-font-h1">Dolphin {$aConf['iVersion']}</div>
                <div class="clear_both">&nbsp;</div>
            </div>
